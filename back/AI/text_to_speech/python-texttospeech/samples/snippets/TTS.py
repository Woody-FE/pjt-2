...
path2 = TTS_ssml('<speak><audio src="https://storage.googleapis.com/my-bgm-file/Face_Hit_Series.mp3" clipBegin="0.2s" clipEnd="0.7s" speed="150%" repeatCount="3"/></speak>','./character_voice/아들/script_11.mp3')
